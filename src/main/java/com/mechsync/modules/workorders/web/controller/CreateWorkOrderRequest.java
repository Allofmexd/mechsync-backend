...
public record CreateWorkOrderRequest(@NotNull @Positive Long vehicleIntakeId,@NotNull @Positive Long technicianId,
 LocalDateTime workOrderDate,LocalDateTime estimatedStartDate,LocalDateTime estimatedDeliveryDate,
